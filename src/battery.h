...
class BatterySensor : public Sensor {
 ...
 private:
  // Source:
  // https://github.com/ThingPulse/esp32-epulse-feather-testbed/blob/main/src/main.cpp
  uint16_t getBatteryVoltageRaw() { return analogRead(BAT_MON_PIN); }
