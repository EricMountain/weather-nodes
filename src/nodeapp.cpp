...
void NodeApp::displayDeviceMeasurements(JsonObject &measurements_v2,
...
std::pair<bool, std::pair<float, float>> NodeApp::getDeviceMinMax(
...
void NodeApp::displayNodeHeader(JsonPair &node, JsonObject &nodeData,
