...
void test_model_default_constructor(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("", model.getDateTime().c_str());
}

void test_model_set_and_get_datetime(void) {
    Model model;
    model.setDateTime("2025-10-21T15:30:45");
    TEST_ASSERT_EQUAL_STRING("2025-10-21T15:30:45", model.getDateTime().c_str());
}
...
void test_model_from_json_string(void) {
    std::string json = R"({"datetime":"2025-10-21T15:30:45","sun":{"rise":"06:30","transit":"12:45","set":"18:30"}})";
    Model model(json);
...
void test_model_equality_operator(void) {
    Model model1;
    model1.setDateTime("2025-10-21T15:30:45");
    
    Model model2;
    model2.setDateTime("2025-10-21T15:30:45");
...
void test_model_inequality_operator(void) {
    ...
    Model model2;
    model2.setDateTime("2025-10-21T16:30:45");
